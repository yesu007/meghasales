            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-slate-900">
                  <tr>
                    <th className="px-4 py-3 text-left"><button onClick={() => handleSort('invoiceDate')} className="flex items-center gap-1 font-semibold text-white">Invoice <SortIcon col="invoiceDate" /></button></th>
                    ...
                    <th className="px-4 py-3 text-right"><button onClick={() => handleSort('totalAmount')} className="flex items-center gap-1 font-semibold text-white ml-auto">Amount <SortIcon col="totalAmount" /></button></th>
                    {mode === 'open' ? (
                      <>
                      ...
                      <>
                        <th className="px-4 py-3 text-right font-semibold text-white hidden md:table-cell">Paid</th>
                        <th className="px-4 py-3 text-left font-semibold text-white hidden lg:table-cell">Payment Date</th>
                        <th className="px-4 py-3 text-left font-semibold text-white hidden lg:table-cell">Method</th>
                        <th className="px-4 py-3 text-left font-semibold text-white hidden xl:table-cell">Reference</th>
                      </>
                    )}
                ...
                <tbody>
                  {invoices.map((inv, idx) => (
                    <tr key={inv.id} className={`${idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'} hover:bg-amber-50/60 transition-colors`}>
